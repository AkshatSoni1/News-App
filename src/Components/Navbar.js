...
export default class Navbar extends Component {
  render() {
    return (
        ...
        <nav className="navbar fixed-top navbar-dark navbar-expand-lg bg-dark" style={{backgroundColor:"rgb(227 192 255)"}}>
        <div className="container-fluid">
          <Link className="navbar-brand ms-3" to="/">AKS News</Link>
